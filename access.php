...
{
$access=$_POST['access'];
$sql="update admin set status=:access where id=1";
...
<div class="main-page">
                ...
                <div class="col-sm-10">
                <input type="radio" name="access" id="access" value="0" required="required">Access to all students<br>
                <input type="radio" name="access" id="access2" value="1" required="required">Access to only allowed student
                </div>
                                            </div>
                                            <br><br>
                                            <div class="form-group">
