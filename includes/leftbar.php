<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="Chirag Jindal" class="img-circle profile-img">
                                <h6 class="title">Chirag Jindal</h6>
                                <small class="info">ABV-IIITM</small>
                            </div>
                            <!-- /.user-info -->
...
<li class="has-children">
                                        ...
                                        <li><a href="change-password.php"><i class="fa fa fa-server"></i> <span> Admin Change Password</span></a></li>
                                           <li><a href="access.php"><i class="fa fa fa-server"></i> <span> Change Access Permission of Result</span></a></li>
                                    </li>
